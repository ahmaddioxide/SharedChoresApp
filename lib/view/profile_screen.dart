                    ...
                    FutureBuilder(
                      builder: (context, snapshot) {
                        if (snapshot.connectionState == ConnectionState.done) {
                          return BlueText(
                              text: snapshot.data.toString(), fontSize: 16);
                        }
                    ...
                    FutureBuilder(
                        builder: (context, snapshot) {
                          if (snapshot.connectionState ==
                            ...
                            return BlackText(
                                text: snapshot.data.toString(), fontSize: 14);
                          }
                          return const SizedBox(
                              height: 20,
                              width: 20,
                      ...
                      FutureBuilder(
                          builder: (context, snapshot) {
                            if (snapshot.connectionState ==
                                ConnectionState.done) {
                              return BlackText(
                                  text: ":  ${snapshot.data}", fontSize: 14);
                            }
                            return const SizedBox(
                                height: 20,
                                width: 20,
                          ...
                          future: ProfileController.getChoresCompleted()),
                    ],
                  ),
                )
              ],
